...
\begin{document}
\title{\vspace{-4em}{\large Sorbonne Universit\'{e}} \\ TER}
\author{Chris Cohadari}
\date{\today} % TOOD: hand in date
\maketitle
...
In subsection \ref{sec:rankTworelaxation}, we lay the theoretical foundation for the \BH. %(described in subsection \ref{sec:BurerHeuristic}).
...
\todo[inline]{Add sentence or two explaining subsections.}
%Presenting the results for instances with known optimal value in 
...
%The subsection will culminate in giving a classification of angular representation of cuts as extremal points of the objective function of the relaxation.
...
%Therefore we can apply the same analysis as in subsection \ref{sec:GoemansWilliamson} yielding the 
...
%As $ \theta $ is not necessarily a optimum solution to \BQP (\ref{def:relaxedbqp}) we have to bound with $ \psi ( \theta) $ instead of the optimal value.

%\textcolor{red}{Let us quickly go over the changes: \\
%As $ f $ is nonconvex, we cannot expect to find the global minimum, only a local minimum.
...
Measuring the number of produced cuts will help us in evaluating the trade-off between improved solutions and increased runtime.%out the benefit of improved solutions versus the increased runtime for bigger parameters.
...
%Therefore the previous observations cannot be a thorough explanation of the performance.
\begin{figure}
\includegraphics[width=\textwidth]{plots/OverviewPerformanceSolversResized.pdf}
...
\improvement{Mit tabelle ersetzen}
...
\begin{figure}
\includegraphics[width=\textwidth]{plots/gka8b.mc.pdf}
...
%This demonstrates, that while running solver M20.N05 there must have been generated a particularly good seed and or perturbation, which allowed to find a ratio of 0.643.
%The bigger instances demonstrate the role that randomness and thus "luck" plays in our algorithm.
%Especially for the bigger instances, we can see the role that the randomly generated starting point plays. 
...
\begin{figure}
\includegraphics[width=\textwidth]{plots/gka10b.mc.pdf}
...
\begin{figure}
\includegraphics[width=\textwidth]{plots/gka1b.mc.pdf}
\end{figure} 
\begin{figure}
\includegraphics[width=\textwidth]{plots/gka2b.mc.pdf}
\end{figure} 
\begin{figure}
\includegraphics[width=\textwidth]{plots/gka3b.mc.pdf}
\end{figure} 
\begin{figure}
\includegraphics[width=\textwidth]{plots/gka4b.mc.pdf}
\end{figure} 
\begin{figure}
\includegraphics[width=\textwidth]{plots/gka5b.mc.pdf}
\end{figure} 
\begin{figure}
\includegraphics[width=\textwidth]{plots/gka6b.mc.pdf}
\end{figure} 
\begin{figure}
\includegraphics[width=\textwidth]{plots/gka7b.mc.pdf}
\end{figure} 
\begin{figure}
\includegraphics[width=\textwidth]{plots/gka8b.mc.pdf}
\end{figure} 
\begin{figure}
\includegraphics[width=\textwidth]{plots/gka9b.mc.pdf}
\end{figure} 
\begin{figure}
\includegraphics[width=\textwidth]{plots/gka10b.mc.pdf}
\end{figure} 
