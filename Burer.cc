...
// Definition of global variables in BurerGlobal.hh (!)
int Burer::G_n;
int Burer::G_m;
int * Burer::G_first;
int * Burer::G_second;
double * Burer::G_weight;
...
Burer2002Solution::Burer2002Solution(
				     double w1norm,
  ...
  // Procedure-CUT implementation starts here:
...
Burer2002::Burer2002(int n, int m, int * f, int * s, double * w)
{
